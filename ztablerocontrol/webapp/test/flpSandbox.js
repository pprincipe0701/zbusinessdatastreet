		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#nebulacomztablerocontrol-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"nebulacomztablerocontrol-display": {
								"semanticObject": "nebulacomztablerocontrol",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=nebula.com.ztablerocontrol",
									"url": sap.ui.require.toUrl("nebula/com/ztablerocontrol")
								}
							}
						}
					}
