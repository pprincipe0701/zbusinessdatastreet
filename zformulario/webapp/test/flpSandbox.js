		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Formulario Captura de datos",
									"targetURL": "#nebulacomzformulario-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"nebulacomzformulario-display": {
								"semanticObject": "nebulacomzformulario",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=nebula.com.zformulario",
									"url": sap.ui.require.toUrl("nebula/com/zformulario")
								}
							}
						}
					}
