		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Genera Ticket",
									"targetURL": "#nebulacomzticket-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"nebulacomzticket-display": {
								"semanticObject": "nebulacomzticket",
								"action": "display",
								"description": "Genera Ticket",
								"title": "Genera Ticket",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=nebula.com.zticket",
									"url": sap.ui.require.toUrl("nebula/com/zticket")
								}
							}
						}
					}
