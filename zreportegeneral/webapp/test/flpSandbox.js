		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#nebulacomzreportegeneral-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"nebulacomzreportegeneral-display": {
								"semanticObject": "nebulacomzreportegeneral",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=nebula.com.zreportegeneral",
									"url": sap.ui.require.toUrl("nebula/com/zreportegeneral")
								}
							}
						}
					}
